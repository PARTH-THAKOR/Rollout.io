...
/**
 * Global centralized exception handling component for SDK Service.
 * Intercepts HTTP errors, validation flaws, and data exceptions to return a unified JSON ApiResponse.
 */
@Slf4j
